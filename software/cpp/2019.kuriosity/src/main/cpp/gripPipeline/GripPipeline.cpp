...
void GripPipeline::Process(cv::Mat& source0){
	...
	double resizeImageHeight = 250.0;  // default Double
	...
	//Step Desaturate0:
	//input
	cv::Mat desaturateInput = resizeImageOutput;
	desaturate(desaturateInput, this->desaturateOutput);
	//Step Find_Lines0:
	//input
	cv::Mat findLinesInput = desaturateOutput;
	findLines(findLinesInput, this->findLinesOutput);
	//Step Filter_Lines0:
	//input
	std::vector<Line> filterLinesLines = findLinesOutput;
	double filterLinesMinLength = 80.0;  // default Double
	double filterLinesAngle[] = {173.5251798561151, 200.2730375426621};
