...
private:
	...
	std::shared_ptr<TalonSRX> tnxRightMaster;
	std::shared_ptr<TalonSRX> tnxLeftMaster;
	std::shared_ptr<DifferentialDrive> differentialDriveTwo;

    // END AUTOGENERATED CODE, SOURCE=ROBOTBUILDER ID=DECLARATIONS
	std::shared_ptr<TalonSRX> tnxLeftSlave;
	std::shared_ptr<TalonSRX> tnxRightSlave;
