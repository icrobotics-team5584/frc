...
public:
	...
	static std::shared_ptr<CANTalon> subDriveBaseTnxFrontLeft;
	static std::shared_ptr<CANTalon> subDriveBaseTnxRearLeft;
	static std::shared_ptr<CANTalon> subDriveBaseTnxFrontRight;
	static std::shared_ptr<CANTalon> subDriveBaseTnxRearRight;
