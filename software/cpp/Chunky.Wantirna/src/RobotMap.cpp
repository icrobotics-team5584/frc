...
std::shared_ptr<CANTalon> RobotMap::subCameraHorizontal;
std::shared_ptr<CANTalon> RobotMap::subCameraVirtical;
...
void RobotMap::init() {
    ...
    //Commented out so that the camera can run off of these motors
    ...
    subCameraHorizontal.reset(new CANTalon(8));
    lw->AddActuator("SubCamera", "TnxCameraHorizontal", subCameraHorizontal);
    subCameraVirtical.reset(new CANTalon(7));
    lw->AddActuator("SubCamera", "TnxCameraVirtical", subCameraVirtical);
