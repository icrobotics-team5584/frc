...
std::shared_ptr<Encoder> RobotMap::subDriveBaseEncRight;
std::shared_ptr<Encoder> RobotMap::subDriveBaseEncLeft;
...
void RobotMap::init() {
    ...
    subDriveBaseEncRight.reset(new Encoder(2, 3, false, Encoder::k4X));
    lw->AddSensor("SubDriveBase", "EncRight", subDriveBaseEncRight);
    subDriveBaseEncRight->SetDistancePerPulse(1.0);
    subDriveBaseEncRight->SetPIDSourceType(PIDSourceType::kRate);
    subDriveBaseEncLeft.reset(new Encoder(4, 5, false, Encoder::k4X));
    lw->AddSensor("SubDriveBase", "EncLeft", subDriveBaseEncLeft);
    subDriveBaseEncLeft->SetDistancePerPulse(1.0);
    subDriveBaseEncLeft->SetPIDSourceType(PIDSourceType::kRate);
