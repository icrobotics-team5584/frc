...
std::shared_ptr<DoubleSolenoid> RobotMap::subGearCatcherPnuActuator;
...
//    subDriveBaseGyro->Calibrate();
    ...
    subGearCatcherPnuActuator.reset(new DoubleSolenoid(0,1));
    lw->AddSensor("SubGearCatcher", "PnuActuator", subGearCatcherPnuActuator);
