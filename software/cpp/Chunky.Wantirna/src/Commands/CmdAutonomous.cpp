...
//	AddSequential(new CmdAutoDrive(-0.3, 0, 1.5));	//Drive Backward (place gear)
//	AddSequential(new CmdAutoDrive(-0.15, 0, 1.25));
//	AddSequential(new CmdAutoTurn(-0.25, 360));
//      AddSequential(new CmdAutoDriveToPeg());
	AddSequential(new CmdAutoDrive(0.2,0,3));
