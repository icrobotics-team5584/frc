...
OI::OI() {
    ...
    btnGearDoorsOpen.reset(new JoystickButton(joystick1.get(), 1));
    btnGearDoorsOpen->WhileHeld(new CmdLaunchGear());
    btnGearFlapIn.reset(new JoystickButton(joystick1.get(), 5));
