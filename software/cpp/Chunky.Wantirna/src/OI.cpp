...
OI::OI() {
    ...
    btnGearDoorsOpen.reset(new JoystickButton(joystick1.get(), 8));
    btnGearDoorsOpen->WhileHeld(new CmdGearDoorsOpen());
    btnGearPusher.reset(new JoystickButton(joystick1.get(), 7));
