#include "CmdArmPosScaleAuto.h"
#include <iostream>

CmdArmPosScaleAuto::CmdArmPosScaleAuto() {
...
void CmdArmPosScaleAuto::Initialize() {

	std::cout << "Moving arm to scale AUTO:H" << std::endl;

}

// Called repeatedly when this Command is scheduled to run
void CmdArmPosScaleAuto::Execute() {

	Robot::subEncodedArmLift->ArmToScalePosAuto();

}

// Make this return true when this Command no longer needs to run execute()
bool CmdArmPosScaleAuto::IsFinished() {
...
void CmdArmPosScaleAuto::Interrupted() {
	End();
}
