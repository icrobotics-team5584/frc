...
set PROJECTNAME=2020.Roley.ICStreamer
...
ssh %PROJECTACCOUNT% cd %PROJECTWORKSPACE%/server; chmod a+x *.sh

echo ---------------------------------------------------------------------------
echo INFO: forcing line endings in workspace
ssh %PROJECTACCOUNT% cd %PROJECTWORKSPACE%/server; perl -pi -e 's/\r\n/\n/g' *.sh

echo ---------------------------------------------------------------------------
echo INFO: building in remote workspace
ssh %PROJECTACCOUNT% cd %PROJECTWORKSPACE%/server; ./build.sh
