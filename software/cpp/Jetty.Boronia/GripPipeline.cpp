...
void GripPipeline::process(cv::Mat source0){
	...
	double filterContoursMinWidth = 3.0;  // default Double
	double filterContoursMaxWidth = 1000;  // default Double
	double filterContoursMinHeight = 4.0;  // default Double
	double filterContoursMaxHeight = 2000.0;  // default Double
	double filterContoursSolidity[] = {19.784172661870503, 100};
	double filterContoursMaxVertices = 1000000;  // default Double
	double filterContoursMinVertices = 100.0;  // default Double
	double filterContoursMinRatio = 50.0;  // default Double
	double filterContoursMaxRatio = 500.0;  // default Double
