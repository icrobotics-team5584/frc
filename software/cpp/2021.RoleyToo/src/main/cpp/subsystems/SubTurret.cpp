...
SubTurret::SubTurret() {
  ...
  frc::SmartDashboard::PutNumber("Near Goal Offset", -1.05);
  frc::SmartDashboard::PutNumber("Init Line Offset", -1.1);
  frc::SmartDashboard::PutNumber("Trench Offset", -0.2);
  frc::SmartDashboard::PutBoolean("Hood Offset", true);
...
double SubTurret::CalculateHoodAngle(double x) {
  double output = (0.00002*pow(x,4)) - (0.00004*pow(x,3)) - (0.0084*pow(x,2)) - (0.029*x) + (13.148);
  if (frc::SmartDashboard::GetBoolean("Hood Offset", true))
  {
    output += HoodOffsetFunction(x, frc::SmartDashboard::GetNumber("Near Goal Offset", -1.05), frc::SmartDashboard::GetNumber("Init Line Offset", -1.1), frc::SmartDashboard::GetNumber("Trench Offset", -0.2));
  }
  return output;
