...
CmdAuto10Ball::CmdAuto10Ball(SubDriveBase* subDriveBase, SubIntake* subIntake, SubStorage* subStorage, SubTurret* subTurret) : _autonomous{
  ...
  AddCommands(
              ...
              frc2::SequentialCommandGroup{
                ...
                CmdAutoDrive{subDriveBase, &_autonomous, 1.7, -4.048, 1.7, -5.553, 180, 0, 0, PIDk{-5, 0, -50}, 0.5, 0, PIDk{1, 0, 0}},
                ...
                //frc2::InstantCommand([subIntake]{subIntake->Deploy();}),
                //frc2::InstantCommand([subIntake]{subIntake->Intake();}),
                //CmdAutoDrive{subDriveBase, &_autonomous, 1.7, -7.553, 1.7, -4.548, 0, 0, 0, PIDk{-5, 0, -50}, 1, 0, PIDk{1, 0, 0}},
                //frc2::InstantCommand([subIntake]{subIntake->Stop();}),
