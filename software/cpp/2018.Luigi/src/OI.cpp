...
OI::OI() {
	...
	axsIntake.reset(new AxisButton(joystick0.get(), 2));
	axsIntake->WhileHeld(new CmdIntake(axsIntake->GetAxis())); //GetAxis() returns the position of the axsIntake trigger
