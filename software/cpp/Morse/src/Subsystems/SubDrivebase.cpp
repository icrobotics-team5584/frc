...
SubDrivebase::SubDrivebase() : Subsystem("SubDrivebase") {
    ...
    diAutoSelector = RobotMap::subDrivebaseDiAutoSelector;
...
void SubDrivebase::Drive(double power, double curve){
	dRV->ArcadeDrive(power, curve);
}
...
bool SubDrivebase::GetAutoMode(){
	return diAutoSelector->Get();
}
