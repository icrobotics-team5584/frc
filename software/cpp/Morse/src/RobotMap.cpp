...
//Gear Pickup
std::shared_ptr<DoubleSolenoid> RobotMap::subGearPickupPnuScoop;
std::shared_ptr<CANTalon> RobotMap::subGearPickupTnxSuck;
...
void RobotMap::init() {
    ...
    subDrivebaseCANTalonLeftDiciple.reset(new CANTalon(4));
    ...
    subDrivebaseCANTalonLeftDiciple->Set(3);
    subDrivebaseCANTalonRightDiciple.reset(new CANTalon(2));
    ...
    subDrivebaseCANTalonRightDiciple->Set(1);

    //Create Actuators for SubGearPickup
    subGearPickupPnuScoop.reset(new DoubleSolenoid(1,3));
    lw->AddSensor("SubGearPickup", "PnuScoop", subGearPickupPnuScoop);
    subGearPickupTnxSuck.reset(new CANTalon(6));
    lw->AddActuator("SubGearPickup", "TnxSuck", subGearPickupTnxSuck);
}
