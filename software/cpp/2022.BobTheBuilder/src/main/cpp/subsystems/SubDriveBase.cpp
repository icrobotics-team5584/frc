...
void SubDriveBase::Periodic() {
  frc::SmartDashboard::PutNumber("Encoder Position", _talonDolly.GetSelectedSensorPosition());
  frc::SmartDashboard::PutNumber("Encoder Velocity", _talonDolly.GetSelectedSensorVelocity());
}
