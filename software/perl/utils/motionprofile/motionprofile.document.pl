...
foreach( sort( keys( %profiles ) ) )
  ...
  print DOC $tr_open;
  print DOC $td_open;
  print DOC "<h1>Motion Profiles for '${profile}' Run</h1>\n";
  print DOC $td_close;
  print DOC $tr_close;
  
  print DOC $tr_open;
  print DOC $td_open;
  print DOC "<img src=\"MotionProfile${profile}A.png\" alt=\"MotionProfile${profile}A\">\n";
  print DOC "<img src=\"MotionProfile${profile}B.png\" alt=\"MotionProfile${profile}B\">\n";
  print DOC $td_close;
  print DOC $tr_close;
